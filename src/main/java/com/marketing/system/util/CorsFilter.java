    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            if (null == token || token.isEmpty()) {
                if (url.contains("getCEOHomeProjectInfos") || url.contains("selectInsertProReturnLog") || url.contains("selectInsertProPassLog") || url.contains("passOrReject") || url.contains("getCEOHomePageDevelopProducts") || url.contains("getCEOHomePageApprovedProducts") || url.contains("getCEOHomePageActivityProducts") || url.contains("getCEOHomePage") || url.contains("index") || url.contains("doc") || url.contains("webjars/bycdao") || url.contains("getGifCode")) {
                    isFilter = true;
                } else {
